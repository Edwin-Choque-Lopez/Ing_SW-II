                        ...
                        <div class="row gx-4 gy-4">
                            <div class="col-lg-8">
                                <div class="row gy-3">
                                    ...
                                    <div class="col-md-12">
                                        <label for="technical_notes" class="form-label">Especificaciones Técnicas</label>
                                        <div class="input-group">
                                            <span class="input-group-text"><i class="bi bi-gear-fill"></i></span>
                                            <textarea id="technical_notes" name="technical_notes" class="form-control @error('technical_notes') is-invalid @enderror" rows="3">{{ old('technical_notes', $product->technical_notes) }}</textarea>
