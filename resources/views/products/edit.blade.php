...
@section('title')
    ...
    <p class="text-subtitle text-muted">Modifique la información del producto {{ $product->name }}</p>
@endsection
@section('navegacion')
                    ...
                    <form action="{{ route('products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row gx-4 gy-4">
                            <div class="col-lg-8">
                                <div class="row gy-3">
                                    <div class="col-md-6">
                                        <label for="oem" class="form-label">Código OEM</label>
                                        <div class="input-group">
                                            <span class="input-group-text"><i class="bi bi-box-seam"></i></span>
                                            <input type="text" id="oem" name="oem" value="{{ old('oem', $product->oem) }}" class="form-control @error('oem') is-invalid @enderror" required>
                                            @error('oem')
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select id="status_id" name="status_id" class="form-select @error('status_id') is-invalid @enderror" required>
                                                ...
                                                @foreach($statusProducts as $id => $label)
                                                    <option value="{{ $id }}" @selected(old('status_id', $product->status_id) == $id)>{{ $label }}</option>
                                                @endforeach
                                            </select>
                                            @error('status_id')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" step="0.01" id="price_buy" name="price_buy" value="{{ old('price_buy', $product->price_buy) }}" class="form-control @error('price_buy') is-invalid @enderror" required>
                                            @error('price_buy')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" step="0.01" id="price_sell" name="price_sell" value="{{ old('price_sell', $product->price_sell) }}" class="form-control @error('price_sell') is-invalid @enderror" required>
                                            @error('price_sell')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" id="stock" name="stock" value="{{ old('stock', $product->stock) }}" class="form-control @error('stock') is-invalid @enderror" required>
                                            @error('stock')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" id="min_stock" name="min_stock" value="{{ old('min_stock', $product->min_stock) }}" class="form-control @error('min_stock') is-invalid @enderror" required>
                                            @error('min_stock')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <textarea id="compatibility_notes" name="compatibility_notes" class="form-control @error('compatibility_notes') is-invalid @enderror" rows="3">{{ old('compatibility_notes', $product->compatibility_notes) }}</textarea>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <textarea id="technical_specs" name="technical_specs" class="form-control @error('technical_specs') is-invalid @enderror" rows="3">{{ old('technical_specs', $product->technical_specs) }}</textarea>
                            ...
                            <div class="col-lg-4">
                                <div class="card border rounded p-3 h-100">
                                    <div class="mb-3">
                                        <label for="image_main" class="form-label">Imagen del Producto</label>
                                        <div class="input-group">
                                    ...
                                    <div class="text-center mb-3">
                                        <div id="productImagePlaceholder" class="d-flex align-items-center justify-content-center rounded bg-light" style="height: 240px;">
                                            <i class="bi bi-card-image fs-1 text-secondary"></i>
                                        </div>
                                        <img id="productImagePreview" src="{{ $product->image_main ? asset('storage/' . $product->image_main) : '' }}" alt="Vista previa de producto" class="img-fluid rounded mx-auto d-block {{ $product->image_main ? '' : 'd-none' }}" style="max-height: 240px;">
                                    </div>
...
function previewProductImage(event) {
    ...
    if (!file) {
        // Si no hay archivo, mostrar la imagen actual o placeholder
        if ('{{ $product->image_main }}') {
            preview.classList.remove('d-none');
            placeholder.classList.add('d-none');
            preview.src = '{{ $product->image_main ? asset('storage/' . $product->image_main) : '' }}';
        } else {
