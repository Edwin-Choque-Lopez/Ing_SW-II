...
@section('title')
    <h3 class="fw-bold">Detalle de reserva: <span class="text-info">{{ $reservation->code_order }}</span></h3>
    <p class="text-subtitle text-muted d-flex align-items-center">
        Revisa la información del cliente, los ítems reservados y el estado actual de esta orden.
    </p>
@endsection
...
@section('navegacion')
    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('reservationId', ['id' => $reservation->status_id]) }}">Reservas</a></li>
            ...
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-body">
                        ...
                        <p class="mb-0"><strong>Notas del cliente:</strong></p>
        ...
        <div class="col-lg-8">
            <div class="card">
                <div class="card-header d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3">
                    <div>
                        <h4 class="card-title mb-1">Resumen de la reserva</h4>
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-end">
                            <div class="border rounded p-3 bg-light">
                                <p class="mb-2"><strong>Subtotal calculado:</strong> Bs. {{ number_format($reservation->ReservationItems->sum('item_subtotal'), 2) }}</p>
                                <p class="mb-0"><strong>Total reserva:</strong> Bs. {{ number_format($reservation->total, 2) }}</p>
                            </div>
                        </div>
                    </div>
                </div>
